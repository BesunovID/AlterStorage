    ...
    return(
        <>
            <ToggleButtonGroup name='tables-btn-choose' className='col-md-2 p-0 pt-2 h-100' type='radio' defaultValue={selectBtn} onChange={handleChooseTable} vertical>
                ...
                <ToggleButton id="main-btn-3" value={urlList.shelf} variant={selectBtn === 'shelf' ? "primary" : 'light'}>Полки</ToggleButton>
                <ToggleButton id="main-btn-4" value={urlList.assemblings} variant={selectBtn === 'assemblings' ? "primary" : 'light'}>Сборки</ToggleButton>
            </ToggleButtonGroup>
        </>
    )
}